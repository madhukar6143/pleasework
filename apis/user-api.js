...
userApi.use(exp.static(path.join(__dirname, './dist/delish/')))

const checkToken=require("./middlewares/verifyToken")

userApi.use(exp.json())

const databaseUrl="mongodb+srv://new1:test123@srini.dvcom.mongodb.net/delishdb?retryWrites=true&w=majority"
...
mc.connect(databaseUrl,{useNewUrlParser:true,useUnifiedTopology:true},(err,client)=>{
    if(err){
        ...
        databaseObj=client.db("delishdb");
        userCollectionsObj=databaseObj.collection("usercollection")
